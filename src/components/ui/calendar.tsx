  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "text-muted-foreground w-9 flex items-center justify-center select-none rounded-md text-[0.8rem] font-medium p-0",
        ...
        day: cn(
          "group/day relative aspect-square h-9 w-9 m-0 flex items-center justify-center select-none p-0 text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 flex aspect-square h-9 w-9 min-w-9 flex-col items-center justify-center gap-1 font-normal leading-none data-[range-end=true]:rounded-md data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-md group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] [&>span]:text-xs [&>span]:opacity-70 bg-transparent hover:bg-accent hover:text-accent-foreground",
        defaultClassNames.day,
        className
      )}
      {...props}
